function out = VortexID(varargin)
...
% O - vorticity
%
%adapted from: Martin Kearney-Fischer - 05-03-2010
...
%% CORE PROGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
S = size(u); L = zeros(S); Q = L; D = L; L2 = L; O = L;   %Initializes output arrays
...
O=dvdx(:,:,1)-dudy(:,:,1); %O=2*curl(x,y,u,v); % vorticity
